...
const BACKEND_NAME: &str = "deepfang-backend.exe";
const BACKEND_PORT: u16 = 10956;
const BACKEND_TAG: &str = "deepfang-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "DEEPFANG_PORT";
const ENV_HOST: &str = "DEEPFANG_HOST";
const ENV_TAURI: &str = "DEEPFANG_TAURI";
