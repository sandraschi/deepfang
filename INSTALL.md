...
4. Start the server:
   ...
   uv run python -m deepfang.server

   # HTTP mode (for web dashboard)
   uv run uvicorn deepfang.server:app --port 10956
   ```
5. Open `http://localhost:10956` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/deepfang/issues) |
